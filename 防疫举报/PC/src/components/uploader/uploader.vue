...
<style lang='less'>
    ...
    .file-uploader{
	  float:left;width:120px;height: 120px;background: url(~assets/img/uploader/upload_bg.png) center center no-repeat;border-radius: 2px;cursor: pointer;text-align: center;border:1px solid rgba(0,0,0,.15);
      .tipt{
