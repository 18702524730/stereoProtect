<template>
  <div class="orderDetail ssDetail">
    ...
    <div class="box detail">
      <h3>申诉详情信息</h3>
      <div class="item"><p class="des">申诉平台</p><p class="content">{{orderDetail.platform}}</p></div>
      <div class="item"><p class="des">被投诉侵犯知识产权类型</p><p class="content">{{orderDetail.intellectualPropertyTypeText}}</p></div>
