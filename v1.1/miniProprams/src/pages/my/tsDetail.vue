<template>
  <div class="orderDetail tsDetail">
    ...
    <div class="box detail">
      <h3>投诉详情信息</h3>
      <div class="item"><p class="des">投诉平台</p><p class="content">{{orderDetail.platform}}</p></div>
      <div class="item"><p class="des">投诉网址</p><p class="content">{{orderDetail.website}}</p></div>
      <div class="item"><p class="des">投诉内容</p><p class="content">{{orderDetail.content}}</p></div>
